...
class ReachCoffeePotTerminations:
    ...
    success = DoneTerm(
        func=reach_object,
        params={"object": "coffee_pot", "tolerance": 0.05},
    )


@dataclass
class RotatedReachCoffeePotTask(Task):
    contact_object_list = ["coffee_pot", "table"]
    ...
    subtasks = [
        Subtask(
            ...
            conditions={
                "coffee_pot": [
                    (partial(reach_object, object="coffee_pot", tolerance=0.04), 1.0)
                ]
            },
            logical="all",
            score=1.0,
